            ...
            <div className="relative z-10 flex flex-col items-center -mt-16">
              <div className="animate-float">
                <img 
                  src={patitoHero} 
                  alt="Patito Milagro"
                  className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-cover rounded-full shadow-[0_30px_60px_-15px_rgba(249,115,22,0.7)] border-8 border-orange-500 bg-white/90"
                />
              </div>
            </div>
