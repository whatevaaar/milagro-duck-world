                ...
                <div className="relative space-y-6">
                  ...
                  <h3 className="text-2xl font-bold text-center text-yellow-600 dark:text-yellow-400 drop-shadow-lg mb-2">
                   ...
                   <div className="relative h-64 bg-yellow-100/50 dark:bg-yellow-900/20 rounded-2xl border-2 border-yellow-400/30 overflow-hidden">
                     ...
                     <div className="absolute top-[63%] left-4 right-4 h-1 bg-yellow-400/50 transform -translate-y-1/2" />
                    ...
                    <div className="absolute left-4 top-[68%] transform -translate-y-1/2">
                     ...
                     {/* Albergue (META) */}
                     <div className="absolute right-4 top-[68%] transform -translate-y-1/2">
                       <div className="flex flex-col items-center gap-1">
                         <img 
                           src={albergueFinal} 
