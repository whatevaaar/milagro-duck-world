        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="relative flex items-center justify-center min-h-[90vh] pt-4">
            ...
            <div className="absolute bottom-[2%] left-[-0.5%] z-40">
              <p className="text-xs md:text-sm font-baloo font-semibold text-yellow-400 px-4 py-2 inline-flex items-center gap-2 drop-shadow-[0_0_20px_rgba(255,215,0,0.8)] [text-shadow:_2px_2px_0_#000,_-2px_-2px_0_#000,_2px_-2px_0_#000,_-2px_2px_0_#000]">
                UN MUNDO DE FELICIDAD Y TERNURA 
                <Sparkles className="w-3 h-3 md:w-4 md:h-4 inline-block" />
                <span className="text-xs md:text-sm">🦆</span>
                <Heart className="w-3 h-3 md:w-4 md:h-4 inline-block fill-yellow-400" />
              </p>
            </div>
