          ...
          <div className="relative flex items-center justify-center min-h-[90vh] pt-4">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-30">
              <div className="relative w-[100vmin] h-[100vmin] max-w-[850px] max-h-[850px] pointer-events-auto">
                ...
                <div className="absolute top-[20%] left-[10%] transform -translate-x-1/2 -translate-y-1/2 animate-bounce" style={{ animationDelay: '0s' }}>
                ...
                <div className="absolute top-[20%] right-[10%] transform translate-x-1/2 -translate-y-1/2 animate-bounce" style={{ animationDelay: '0.2s' }}>
                  <div className="bg-white/90 rounded-full p-2 shadow-[0_8px_20px_-6px_hsl(199_89%_48%/0.5)] backdrop-blur-sm border-2 border-accent/30">
                    <DuckMenuButton 
                      icon={Theater} 
                      label="Obra" 
